...
import com.example.practice23.mbeans.DataClearAndExportTaskMBean;
import com.example.practice23.models.Student;
import com.example.practice23.models.University;
import com.example.practice23.repositories.StudentRepository;
import com.example.practice23.repositories.UniversityRepository;
...
public class SchedulerService implements DataClearAndExportTaskMBean, DynamicMBean {
    ...
    @Scheduled(initialDelayString = "PT030M", fixedDelayString = "PT030M")
